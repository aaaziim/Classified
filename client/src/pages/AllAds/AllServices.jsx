...
const AllServices = () => {
  ...
  const fetchServicesWithFilter = async (
    searchText,
    category,
    subcategory,
    country,
    ...
    try {
      ...
      const response = await axiosSecure(
        `/servicesbyfilter?searchtext=${encodeURIComponent(
          searchText
          ...
          state
        )}&city=${encodeURIComponent(city)}&page=${page}&limit=${limit}`
      );
      setServices(response.data.services); // Use 'services' from the response
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-6">
          <div>
              ...
              <form onSubmit={handleFilter}>
                <div className="flex p-1 overflow-hidden border rounded-lg focus-within:ring focus-within:ring-opacity-40 focus-within:border-[#FA8649] focus-within:ring-[#FA8649]">
                  ...
                  <input
                    type="submit"
                    value="Search"
                    className="px-1 md:px-4 py-3 mx-2 text-sm font-medium tracking-wider text-white uppercase transition-colors duration-300 transform bg-[#014D48] rounded-md hover:bg-[#001C27] focus:bg-[#001C27] focus:outline-none"
                  />
                </div>
              </form>
            </div>
            ...
            <button
              ...
              className="w-full px-1 md:px-4 py-3 my-2 text-sm font-medium tracking-wider text-white uppercase transition-colors duration-300 transform bg-[#014D48] rounded-md hover:bg-[#001C27] focus:bg-[#001C27] focus:outline-none"
            >
              Apply Filter
            </button>
          </div>
