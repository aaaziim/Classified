      ...
      >
        <div className="relative">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
            ...
            <p className="text-sm md:text-xl font-semibold text-[#FFE5D5] ">Post your services and reach thousands of potential customers today
            </p>
        ...
        <div className="relative">
          ...
          {/* Content */}
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
            <h2 className="text-lg md:text-3xl font-bold text-[#FA8649]">Browse Available Services
            </h2>
        ...
        <div className="relative">
          ...
          {/* Content */}
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
            <h2 className="text-lg md:text-3xl font-bold text-[#FA8649]">Create Your Event
            </h2>
            <p className="text-sm md:text-xl font-semibold text-[#FFE5D5] ">Promote your upcoming events and gather the crowd you need.
            </p>
            <Link to="/post-events">
              <button className="mt-2 md:mt-6 px-6 md:py-2 bg-[#FA8649] text-white font-semibold rounded-md hover:bg-[#014D48] transition-colors">
                Post Event
        ...
        <div className="relative">
          ...
          {/* Content */}
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
            <h2 className="text-lg md:text-3xl font-bold text-[#FA8649]">Discover Exciting Events
            </h2>
